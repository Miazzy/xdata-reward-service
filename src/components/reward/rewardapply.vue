        ...
        <keep-alive>
          <a-col :xl="24" :lg="24" :md="24" :sm="24" :xs="24">
            ...
            <div style="background-color:#f0f0f0;">
              ...
              <div class="reward-apply-content" style="height:auto; background-color:#fefefe; margin-top:0px; margin-left: 1.0rem; margin-right: 1.0rem; margin-bottom: 5rem; border: 1px solid #f0f0f0; front-size: 1rem;" >
