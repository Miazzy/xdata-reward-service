            ...
            <div style="background-color:#f0f0f0;">
              ...
              <div class="reward-apply-content" style="height:auto; background-color:#fefefe; margin-top:0.00rem; margin-left: 0.00rem; margin-right: 0.00rem; margin-bottom: 5rem; border: 0px solid #f0f0f0; front-size: 1rem;" >
                ...
                <div class="reward-apply-content-item" style="margin-top:5px;margin-bottom:5px;">
                  <a-row>
                    <a-col :span="4 * (iswechat?2:1)" :style="iswechat?`font-size:1.0rem; margin-top:5px; text-align: center;`:`font-size:1.0rem; margin-top:5px; text-align: center;`">
                ...
                <div class="reward-apply-content-item" style="margin-top:5px;margin-bottom:5px; margin-right:10px;">
                  <a-row>
                    ...
                    <a-col :span="4 * (iswechat?2:1)" style="font-size:1.0rem; margin-top:8px; text-align: center;">
                ...
                <div class="reward-apply-content-item reward-apply-content-title" style="">
                  <a-row :style="iswechat?`border-top: 1px dash #f0f0f0;margin:0px 0.25rem;`:`border-top: 1px dash #f0f0f0;margin:0px 5rem;`" >
                     <vue-excel-editor v-model="data" ref="grid" width="100%" :page="30" :no-num-col="false" :readonly="true" filter-row :localized-label="vueExcelLabels" autocomplete @delete="onDelete" @update="onUpdate" >
                ...
                <div v-show="panename == 'myapplylist' && typename == 'create_by' && (bpm_status == '1' || bpm_status == '100') && workflowLogList.length == 0 && role != 'view' " class="reward-apply-content-item" style="margin-top:35px;margin-bottom:5px; margin-right:10px;">
                  ...
                  <div v-show="approve_executelist.length > 0" class="reward-apply-content-item reward-apply-content-title" style="">
                    <a-row style="border-top: 1px dash #f0f0f0;margin:0px 5rem;" >
                      <vue-excel-editor v-model="approve_executelist" ref="grid_execute" width="100%" :page="100" :no-num-col="false" :readonly="false" no-footer :localized-label="vueExcelLabels" autocomplete @delete="onDelete" @update="onUpdateExecute" >
...
export default {
  ...
  methods: {
      ...
      async handleNotifyConfirm(){
        ...
        await this.handleLogNode(id , false , true);
