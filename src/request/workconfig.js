        ...
        taskflows: [{
                ...
                click: async() => {
                    ...
                    if (response && response.length > 0) {
                        ...
                        that.$notification.warning({ message: '温馨提示', description: '您没有查看月度报表的权限！' });
                    }
                },
            }, {
                name: "季度报表",
                ...
                click: async() => {
                    ...
                    if (response && response.length > 0) {
                        ...
                        that.$notification.warning({ message: '温馨提示', description: '您没有查看季度报表的权限！' });
                    }
                },
            }, {
                name: "年度报表",
                ...
                click: async() => {
                    ...
                    if (response && response.length > 0) {
                        ...
                        that.$notification.warning({ message: '温馨提示', description: '您没有查看年度报表的权限！' });
                    }
                },
            }, {
                name: "月度图表",
                ...
                click: async() => {
                    ...
                    if (response && response.length > 0) {
                        ...
                        that.$notification.warning({ message: '温馨提示', description: '您没有查看月度图表的权限！' });
                    }
                }
            }, {
                name: "季度图表",
                ...
                click: async() => {
                    ...
                    if (response && response.length > 0) {
                        ...
                        that.$notification.warning({ message: '温馨提示', description: '您没有查看季度图表的权限！' });
                    }
                }
            }, {
                name: "年度图表",
                ...
                click: async() => {
                    ...
                    if (response && response.length > 0) {
                        ...
                        that.$notification.warning({ message: '温馨提示', description: '您没有查看年度图表的权限！' });
                    }
                }
            },
            // {
...
export const columns = {
    reward: {
        ...
        vueExcelLabels: {
            ...
            readonlyColumnDetected: '不可更新只读记录',
        ...
        rewardtname: ['投资体系业绩考核奖', '资金体系业绩考核奖', '运营体系业绩考核奖', '运营体系成本管理业绩考核奖', '运营体系质量安全业绩考核奖', '资金回笼业绩考核奖', '财税业绩考核奖', '商业承兑汇票业绩考核奖', '工程抵款业绩考核奖', '房开司签约回款业绩考核奖', '营销签约回款业绩考核奖'],
    }
}
